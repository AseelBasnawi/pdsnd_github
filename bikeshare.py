...
CITY_DATA = { 'ch' 'chicago': 'chicago.csv',
...
def get_filters():
    ...
    city = input("Enter the city:\nChoose between Chicago 'CH' , New York city 'NY' OR Washington 'WA': ").lower()
    while city not in CITY_DATA:
        city = input ("Enter the city:\nChoose between Chicago 'CH' , New York city 'NY' OR Washington 'WA': ").lower()


    # get user input for month (all, january, february, ... , june)
    month = input('Enter a month name January, February,... , june or you can enter all:  ').lower()
    while month not in ['all','january', 'february', 'march', 'april', 'may', 'june']:
        month = input('Enter a month name January, February,... , june or you can enter all:   ').lower()

    # get user input for day of week (all, monday, tuesday, ... sunday)
    day = input('Enter a day of the week OR you can enter all : ').lower()
